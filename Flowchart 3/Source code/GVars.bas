...
Public CloseOnStop As Boolean
Public ConLne(1 To 150, 0 To 1) As Integer
...
If (App.LogMode = 1) Then
  If GetKeyValue(HKEY_CLASSES_ROOT, "FlowChartDiagram\Shell\Open\command", "") <> """" & App.Path & "\" & App.EXEName & ".exe"" /o %1" Then
     UpdateKey HKEY_CLASSES_ROOT, ".flw", "", "FlowChartDiagram"
     UpdateKey HKEY_CLASSES_ROOT, "FlowChartDiagram", "", "FlowChart Diagram"
     UpdateKey HKEY_CLASSES_ROOT, "FlowChartDiagram\DefaultIcon", "", App.Path & "\" & App.EXEName & ".exe,1"
     UpdateKey HKEY_CLASSES_ROOT, "FlowChartDiagram\Shell\Open\command", "", """" & App.Path & "\" & App.EXEName & ".exe"" /o %1"
     UpdateKey HKEY_CLASSES_ROOT, "FlowChartDiagram\Shell\Run\command", "", """" & App.Path & "\" & App.EXEName & ".exe"" /r %1"
  End If
End If
FlowChart.Show
End Sub
